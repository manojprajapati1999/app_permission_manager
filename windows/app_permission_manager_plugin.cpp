#include "app_permission_manager_plugin.h"
...
// static
void AppPermissionManagerPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "app_permission_manager",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<AppPermissionManagerPlugin>();
...
AppPermissionManagerPlugin::AppPermissionManagerPlugin() {}

AppPermissionManagerPlugin::~AppPermissionManagerPlugin() {}

void AppPermissionManagerPlugin::HandleMethodCall(
